...
The benchmarks used in this study can be downloaded from [Vstar](https://huggingface.co/datasets/craigwu/vstar_bench) and [HR-Bench](https://huggingface.co/datasets/DreamMr/HR-Bench).
...
To facilitate reproducibility, we provide **off-the-shelf reasoning traces** generated by our framework. You can download these traces from the following mirrors:
